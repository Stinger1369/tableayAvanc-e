...
const jsInstructors = instructors.filter(instructor => instructor.specialities.includes('Javascript') && (instructor.availability === 'all' || instructor.availability === 'weekend'));
console.log(jsInstructors);
...
jsInstructors.forEach(instructor => console.log(`Hi ${instructor.name}, we inform you that this weekend you will be doing the support class`));
...
jsInstructors.forEach(instructor => {
